...
class Notifications(INotifications):
    def __init__(self , NotificationID=None , notify_type=None , receiver_email=None , UserID=None, Message=None,Receiver = None, SentAt=None, IsRead=None):
    ...
    def add_notification(self):
        ...
        dbconn.DBCreate(
            ...
            sfld='UserID, Message, IsRead , Receiver ,notify_type , receiver_email',
            svalue=f"{self.__UserID}, '{self.__Message}', {self.__IsRead} , '{self.__Receiver}' , '{self.__notify_type}' , '{self.__receiver_email}'"
        )
        
    def update_notification(self):
        dbconn = DatabaseCRUD()
        cond = ["NotificationID=" + str(self.__NotificationID)]
        sfld = f"UserID={self.__UserID}, Message='{self.__Message}' , notify_type='{self.__notify_type}', SentAt='{self.__SentAt}', IsRead={self.__IsRead} , Receiver='{self.__Receiver}' , receiver_email='{self.__receiver_email}'"
